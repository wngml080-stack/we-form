        ...
        <div className="bg-slate-900 p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-emerald-200/60 text-[10px] font-black uppercase tracking-[0.2em] mt-0.5">Edit Staff Profile</p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Select value={staffEditForm.employment_status} onValueChange={(v: EmploymentStatus) => setStaffEditForm({ ...staffEditForm, employment_status: v })}>
                  ...
                  <SelectContent className="bg-white rounded-2xl border-none shadow-2xl p-2">
                    <SelectItem value="재직" className="rounded-xl font-bold py-3 text-blue-600">재직 중</SelectItem>
