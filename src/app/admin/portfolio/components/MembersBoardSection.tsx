...
export function MembersBoardSection() {
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">관리중인 회원 리스트</h2>
        </div>
      ...
      {/* 회원관리 버튼 */}
      <div className="mb-6">
        <button className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full text-sm font-medium transition-colors">
          회원관리
        </button>
      </div>
