        ...
        <SignIn
          appearance={{
            elements: {
              ...
              socialButtonsBlockButton: "bg-white border-2 border-slate-200 hover:border-primary/50 hover:bg-slate-50 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-300",
              ...
              formFieldInput: "rounded-xl border-2 border-slate-200 focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-300",
