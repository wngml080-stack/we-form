...
async function runMigrations() {
  console.log('🚀 Running migrations via Supabase Studio...\n')
  console.log('⚠️  Please run the following SQL in Supabase Studio (SQL Editor):\n')
...
`)
  console.log('=' .repeat(80))
  console.log('\n✅ Copy the SQL above and paste it into Supabase Studio > SQL Editor > Run\n')
